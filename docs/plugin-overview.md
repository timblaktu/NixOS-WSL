# NixOS-WSL Plugin Integration Overview

This document provides a high-level overview of the WSL plugin integration project for NixOS-WSL, enabling declarative disk management through NixOS configuration.

## Project Overview

This integration implements VSOCK-based communication between the NixOS-WSL systemd-shim and a Windows-side WSL plugin. The system ensures specified bare disks and VHDX files are available before distribution boot proceeds.
...
**Requirements**: Windows container runtime must be installed on Windows host (see [Installation Guide](plugin-installation-guide.md)).
...
- `docs/plugin-overview.md` - This overview document
- `docs/plugin-installation-guide.md` - Windows container setup guide
- `docs/plugin-technical-details.md` - Detailed technical implementation
- `docs/mingw-limitations-analysis.md` - Build strategy analysis
